...
%if %{with perl_Test_NoWarnings_enables_stack_trace}
Requires:       %{?scl_prefix}perl(Devel::StackTrace)
%endif
...
%build
%{?scl:scl enable %{scl} '}perl Makefile.PL NO_PACKLIST=1 INSTALLDIRS=vendor && make %{?_smp_mflags}%{?scl:'}
...
%changelog
* Thu Jan 02 2020 Jitka Plesnikova <jplesnik@redhat.com> - 1.04-21
- SCL
